...
**Span does not collect any personal information. Period.**

No accounts. No analytics. No telemetry. No tracking. Your files are your business.
...
Span stores the following data **locally on your device only** to provide its functionality:
...
This data **never leaves your device**. It is not transmitted, synced, or backed up to any external server.

## Network Communication

Span communicates over the network **only** in these user-initiated scenarios:
...
Span does not share, sell, license, or provide any data to any third party for any purpose.

## Data Deletion

Uninstalling Span removes all locally stored settings and data. You can also reset settings within the app at any time.

## Children's Privacy

Span does not collect data from anyone, including children. All users can use the app equally without any data collection.
